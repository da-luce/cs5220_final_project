...
TEST_F(BoardEncodingTest, DynamicChannelCount) {
    GameState state;
...
TEST_F(BoardEncodingTest, BasicPiecePlacement) {
    GameState state;
    state.board = Board(tiny_config);
 ...
 * 3  .   .   .   .
 */
TEST_F(BoardEncodingTest, UnrevealedAndEmptyChannels) {
    GameState state;
    state.board = Board(tiny_config);
 ...
 * 0  1  2  3
 */
TEST_F(BoardEncodingTest, PerspectiveFlip) {
    GameState state;
    state.board = Board(tiny_config);
...
TEST_F(BoardEncodingTest, DynamicConfigGuardrail) {
    GameState state;
    state.board = Board(tiny_config);
