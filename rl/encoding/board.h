 ...
 * We will have a total of (2N + 2) channels in our observation tensor. Each channel
 * is the same dimension of the board (H x W), and the channels are ordered as follows:
